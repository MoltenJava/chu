...
/**
 * Batch prefetch images with individual error handling
 * @param imageUrls Array of image URLs to prefetch
 * @param onProgress Optional callback for progress updates
 * @returns A promise that resolves with an array of successfully prefetched URLs
 */
